...
export const StandingOrderFailurePage = ({ accountMembershipId }: Props) => {
    ...
    <ScrollView accessibilityRole="main" contentContainerStyle={styles.contentContainer}>
      <Box alignItems="center">
        ...
        <Heading level={1} size={32} align="center">
          {t("payments.new.standingOrder.failure.title")}
        </Heading>

        <Space height={8} />

        <Text style={styles.description}>
          {t("payments.new.standingOrder.failure.description")}
        </Text>
      </Box>
