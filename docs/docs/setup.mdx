...
sidebar_label: Set up your instance
---
...
Install [yarn](https://yarnpkg.com/en/docs/install), which is required to mangage the monorepository.
...
You might need to use `sudo` to be able to edit the `hosts` file.
...
By default, your system will warn against a self-signed certificate.
Use [mkcert](https://github.com/FiloSottile/mkcert) to make your system trust the self-signed certificate.
