...
declare module "tggl-client" {
  ...
  export interface TgglFlags {
    ...
    cash_segregation_paused: boolean;
    ...
    corporate_transfers_on_sepa_gateway: boolean;
    ...
    initiateSeizuresInPayment: boolean;
    ...
    override_onboarding_company_fields_with_pappers_data: boolean;
